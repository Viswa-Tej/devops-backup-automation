...
Automated backup system with timestamped archives, configurable retention, rotation of old backups, and Slack alerting on success or failure.
...
![backup](./screenshots/backup-run.png)

### 📄 Log output

![logs](./screenshots/log-file-contents-1.png)

### 🔄 Restore verified

![restore](./screenshots/restore-run.png)
